class Maker{
    ...
    makehtml(
        ...
        idInvoice = 'F1234',
        idOrder = 'O1234',
        mail = 'jesusmoral011096@gmail.com',
        items = [
            {
                Descripcion:'Pizza napolitana',
                Distribuidor:'Pizzeria "El Mana"',
                Precio:40,
                Cantidad:2
            },{
...
eight:20px">
<p><!-- Start legal -->
&#169; 2021, FastFood Todos los derechos reservados.FastFood, 
